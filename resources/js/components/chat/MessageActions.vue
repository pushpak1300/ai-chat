    ...
    <div v-if="!isLoading && message.role === Role.ASSISTANT" class="flex flex-row gap-2">
        <Tooltip>
            <TooltipTrigger as-child>
                <Button class="py-1 px-2 h-fit text-muted-foreground" variant="outline"
        ...
        <Tooltip>
            <TooltipTrigger as-child>
                <Button data-testid="message-upvote" class="py-1 px-2 h-fit !pointer-events-auto"
        ...
        <Tooltip>
            <TooltipTrigger as-child>
                <Button data-testid="message-downvote" class="py-1 px-2 h-fit !pointer-events-auto"
